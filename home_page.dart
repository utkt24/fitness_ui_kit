import 'package:fitness_ui_kit/chart_sleep.dart';
import 'package:fitness_ui_kit/chart_workout_progress.dart';
import 'package:fitness_ui_kit/colors.dart';
import 'package:fitness_ui_kit/latest_workout.dart';
import 'package:fitness_ui_kit/water_intake_progressbar.dart';
import 'package:fitness_ui_kit/water_intake_timeline.dart';
import 'package:fl_chart/fl_chart.dart';
import 'package:flutter/material.dart';
import 'package:line_icons/line_icons.dart';

import 'chart_activity_status.dart';
      ...
      child: SafeArea(
        child: Padding(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 5,),
                      Text("Utkarsh Tripathi",style: TextStyle(
                          fontSize: 20,
                      ...
                      Flexible(
                        child: Container(
                          ...
                          child: Column(
                            ...
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text("BMT (Body Mass Index)",style: TextStyle(
                                fontSize: 14,
                                fontWeight: FontWeight.bold,
                                color: Colors.white
                              ),),
                              Text("You have a normal weight",style: TextStyle(
                                  fontSize: 13,
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: white,
                      boxShadow: [
                        BoxShadow(color: black.withOpacity(0.01),
                        spreadRadius: 20,blurRadius: 10,
                          offset: Offset(0,10)
                        )
                      ],
                      borderRadius: BorderRadius.circular(30)
                                ...
                                decoration: BoxDecoration(
                                  gradient: LinearGradient(
                                    begin: Alignment.topCenter,
                                      colors: [
                                      fourthColor, primary.withOpacity(0.5)
                                  ]),
                                  shape: BoxShape.circle
                                ),
                                child: Center(
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: Text("230 Cal",style: TextStyle(
                                        fontSize: 10,
                                        color: white
                                      ),),
                                    ),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
            Text("Latest Workout",style: TextStyle(
              fontSize: 18,
              fontWeight: FontWeight.bold,
              color: black
          ),),
                            ...
                            Flexible(
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(latestWorkoutJson[0]['title'],style: TextStyle(
                                        fontSize: 14,
                                        fontWeight: FontWeight.bold
                                    ),),
                                    Text(latestWorkoutJson[0]['description'],style: TextStyle(
                                        fontSize: 13,
                                        color: black.withOpacity(0.5)
                                    ),),
                                    Stack(
                                      children: [
                                        ...
                                        Container(
                                          width: size.width*(latestWorkoutJson[0]['progressBar']),
                                          height: 10,
                                          decoration: BoxDecoration(
                                              borderRadius: BorderRadius.circular(30),
                                              gradient: LinearGradient(colors: [
